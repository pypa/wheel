...
def egg2wheel(egg_path: str | PathLike, dest_dir: str | PathLike) -> None:
...
def wininst2wheel(path: str | PathLike, dest_dir: str | PathLike) -> None:
...
def convert(
    ...
    for pattern in files:
        for installer_path in Path.cwd().glob(pattern):
            ...
            if verbose:
                print(f"{installer_path}... ", flush=True)
